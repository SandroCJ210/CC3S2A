...
def test_vaciar_lista():
    ...
    producto1 = ProductoFactory(nombre="Televisión", precio=2000.00)
    producto2 = ProductoFactory(nombre="Laptop", precio=3500.00)
    producto3 = ProductoFactory(nombre="Licuadora", precio=360.00)
...
def test_descuento_condicional_exitoso():
    ...
    total_a_pagar = carrito.aplicar_descuento_condicional(porcentaje = 15, minimo = 1500)
...
def test_agregar_producto_en_stock():
    ...
    producto1 = ProductoFactory(nombre="Televisión", precio=2000.00, stock=10)
